  ...
  return (
      <div>
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-1 mt-8 mx-5">
          <div className="bg-orange-200 p-4 shadow rounded-lg w-100 border-2 border-orange-300 ">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-4 mt-8 mx-5">
        ...
        <div className="bg-orange-200 p-4 shadow rounded-lg h-36 border-2 border-orange-300 ">
        ...
        <div className="bg-orange-200 p-4 shadow rounded-lg border-2 border-orange-300 ">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-1 mt-8 mx-5">
        ...
        <button class="px-7 py-2 text-sm font-mono ml-8 mt-7 text-[#8B7D6B]  border border-[#8B7D6B] bg-transparent hover:bg-[#8B7D6B]/10 transition-colors duration-200">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-1 mt-8 mx-5 mb-5" id="workout">
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 bg-orange-200 p-4 shadow rounded-lg w-100 border-2 border-orange-300 ">
          <div className="bg-orange-100 p-4 shadow rounded-lg  border-2 border-orange-300 ">
          ...
          <button class="px-3 py-1 text-sm  font-mono text-[#8B7D6B] border border-[#8B7D6B] bg-transparent hover:bg-[#8B7D6B]/10 transition-colors duration-200">
  View Workout
</button>
</div>
          </div>
          <div className="bg-orange-100 p-4 shadow rounded-lg w-100 border-2 border-orange-300 ">
